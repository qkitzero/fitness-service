...
func run() error {
	...
	prescribedMenuOverrideRepository := infrajudgment.NewPrescribedMenuOverrideRepository(gormDB)
	prescriptionRuleRepository := infratraining.NewPrescriptionRuleRepository(gormDB)
