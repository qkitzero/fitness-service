...
func TestListMeasurementItems(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			codes:          []string{"pulse_rate", "eyes_closed_one_leg_stand", "cs30", "stand_up_test"},
			names:          []string{"脈拍", "閉眼片足立ち", "CS-30（30秒立ち座り）", "立ち上がり"},
			categories:     []measurementitem.Category{measurementitem.CategoryVital, measurementitem.CategoryMotorFunction, measurementitem.CategoryMotorFunction, measurementitem.CategoryMotorFunction},
			units:          []measurementitem.Unit{measurementitem.UnitBpm, measurementitem.UnitSec, measurementitem.UnitCount, measurementitem.UnitCm},
			trialCounts:    []int{1, 2, 1, 1},
			bilaterals:     []bool{false, true, false, true},
			valueTypes:     []measurementitem.ValueType{measurementitem.ValueTypeNumeric, measurementitem.ValueTypeNumeric, measurementitem.ValueTypeNumeric, measurementitem.ValueTypeChoice},
			wantCode:       codes.OK,
			wantCategories: []measurementitemv1.Category{measurementitemv1.Category_CATEGORY_VITAL, measurementitemv1.Category_CATEGORY_MOTOR_FUNCTION, measurementitemv1.Category_CATEGORY_MOTOR_FUNCTION, measurementitemv1.Category_CATEGORY_MOTOR_FUNCTION},
			wantUnits:      []measurementitemv1.Unit{measurementitemv1.Unit_UNIT_BPM, measurementitemv1.Unit_UNIT_SEC, measurementitemv1.Unit_UNIT_COUNT, measurementitemv1.Unit_UNIT_CM},
			wantValueTypes: []measurementitemv1.ValueType{measurementitemv1.ValueType_VALUE_TYPE_NUMERIC, measurementitemv1.ValueType_VALUE_TYPE_NUMERIC, measurementitemv1.ValueType_VALUE_TYPE_NUMERIC, measurementitemv1.ValueType_VALUE_TYPE_CHOICE},
		},
		{
