...
func TestGetJudgment(t *testing.T) {
	...
	gripStrength := domainmeasurementitem.NewMeasurementItem(gripStrengthID, gripStrengthCode, gripStrengthName, motorFunction, kg, twoTrials, domainmeasurementitem.SideModeBilateral, domainmeasurementitem.ValueTypeNumeric, &higherIsBetter, domainmeasurementitem.TrialAggregationBest, domainmeasurementitem.SideAggregationMean, domainmeasurementitem.NormalizationNone, []domainmeasurementitem.Element{domainmeasurementitem.ElementMuscleStrength}, createdAt, updatedAt)
	unmappedElementItem := domainmeasurementitem.NewMeasurementItem(gripStrengthID, gripStrengthCode, gripStrengthName, motorFunction, kg, twoTrials, domainmeasurementitem.SideModeBilateral, domainmeasurementitem.ValueTypeNumeric, &higherIsBetter, domainmeasurementitem.TrialAggregationBest, domainmeasurementitem.SideAggregationMean, domainmeasurementitem.NormalizationNone, []domainmeasurementitem.Element{domainmeasurementitem.Element("unknown")}, createdAt, updatedAt)
