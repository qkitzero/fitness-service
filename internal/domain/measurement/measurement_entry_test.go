...
func TestNewMeasurementEntry(t *testing.T) {
	...
	pulseRate := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), pulseRateCode, pulseRateName, vital, bpm, singleTrial, measurementitem.SideModeNone, measurementitem.ValueTypeNumeric, nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationMean, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
	bloodPressure := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), bloodPressureCode, bloodPressureName, vital, mmHg, singleTrial, measurementitem.SideModeNone, measurementitem.ValueTypePaired, nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationMean, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
	...
	choiceItem := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), choiceItemCode, choiceItemName, motorFunction, cm, singleTrial, measurementitem.SideModeBilateral, measurementitem.ValueTypeChoice, nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationMean, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
	standUpTest := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), standUpTestCode, standUpTestName, motorFunction, level, singleTrial, measurementitem.SideModeOptionalBilateral, measurementitem.ValueTypeNumeric, nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationWorst, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
	unknownSideMode := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), standUpTestCode, standUpTestName, motorFunction, level, singleTrial, measurementitem.SideMode("unilateral"), measurementitem.ValueTypeNumeric, nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationWorst, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
	unknownValueType := measurementitem.NewMeasurementItem(measurementitem.NewMeasurementItemID(), pulseRateCode, pulseRateName, vital, bpm, singleTrial, measurementitem.SideModeNone, measurementitem.ValueType("range"), nil, measurementitem.TrialAggregationBest, measurementitem.SideAggregationMean, measurementitem.NormalizationNone, nil, itemCreatedAt, itemUpdatedAt)
